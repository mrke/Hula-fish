...
metadata.species_en = 'Southern Hula Fish'; 
...
% data.tL = csvread('mydata_Trachinops_caudimaculatus_tL.csv');
% data.tL = data.tL(:,2)/10;
...
%data.LW = csvread('mydata_Trachinops_caudimaculatus_LW.csv');
%data.LW = data.LW(:,1)/10;
